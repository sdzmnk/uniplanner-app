...
//        return view('admin.study_plan.index', compact('studyPlans'));
    ...
    {
        $studyPlans = StudyPlan::orderBy('year', 'asc')->get();
        $courses = Course::orderBy('name', 'asc')->get();
        $courseTypes = Course::courseTypes();
        return view('admin.study_plan_course.create', compact('studyPlans', 'courses', 'courseTypes'));
...
//
//        return redirect()->back()->withSuccess('Навчальний план успішно додано!');
    }
