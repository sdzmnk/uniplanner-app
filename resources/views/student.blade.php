...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Навчальний план</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <!-- Основной контент учебного плана -->
            @if($studyPlan)
                <div class="row">
                    <div class="col-12">
                        <div class="callout callout-info">
                            <h5><i class="fas fa-info"></i> Примітка:</h5>
                            Деталі вашого навчального плану, включаючи інформацію про курси, спеціальність та інше.
                        </div>
                        ...
                        <div class="invoice p-3 mb-3">
                            ...
                            <div class="row no-print">
                                <div class="col-12">
                                    <a href="{{ route('dashboard') }}" class="btn btn-secondary float-right">Назад</a>
                                </div>
                            </div>
                            ...
                            <a class="btn btn-danger" href="{{ route('student.study_plan.generate_pdf', $studyPlan->id) }}">
                                <i class="fa-regular fa-file-pdf"></i> Експорт у PDF
                            </a>
                            <a class="btn btn-success" href="{{ route('student.study_plan.export', $studyPlan->id) }}">
