...
<head>
    ...
    <title> UniPlanner @yield('title')</title>
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{route('admin.index')}}" class="brand-link">
            <span class="brand-text font-weight-light">UniPlanner</span>
        </a>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('study_plan.index')}}" class="nav-link ">

                                    <p>Переглянути навч. плани</p>
                                </a>
                            </li>
                        </ul>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('study_plan.create')}}" class="nav-link ">
                                    <p>Створити навч. план</p>
                                </a>
                            </li>
                        </ul>
                </ul>
    ...
    <footer class="main-footer">
        <strong>UniPlanner: керування навчальними планами </strong>
    </footer>
